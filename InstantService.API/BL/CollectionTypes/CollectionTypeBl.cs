...
namespace InstantService.API.BL.CollectionTypes
{
    public class CollectionTypeBl: CollectionTypeRepository, ICollectionTypeBl
    {
        ...
        public CollectionTypeBl(InstantServiceContext context) :
            base(context)
        {
            _context = context;
        }
