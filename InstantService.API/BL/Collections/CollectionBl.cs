...
namespace InstantService.API.BL.Collections
{
    public class CollectionBl: CollectionRepository, ICollectionBl
    {
        ...
        public CollectionBl(InstantServiceContext context) :
            base(context)
        {
            _context = context;
        }
