...
namespace InstantService.API.DAL.Repositories.CollectionDetails
{
    /// <summary>
    ///     <para>
    ///         This class implements the methods concerning the management 
    ///         of CollectionDetails defined in the ICollectionDetailRepository class.
    ///     </para>
    /// </summary>
    public class CollectionDetailRepository : BaseRepository<InstantServiceContext,CollectionDetail>, ICollectionDetailRepository
    {
        ...
        public CollectionDetailRepository(InstantServiceContext context): base(context)
        {
            _context = context;
        }
